...
hero:
  name: Pinia 从零实现
  text: 亲手写出你自己的 Pinia
  tagline: 12 章演进一个约 680 行、API 与真 pinia 同构的 pinia-mini——createPinia、defineStore、两种 store 语法、$patch、$reset、$subscribe、$onAction、storeToRefs、插件系统。适合会用 Vue 3 组合式 API、想真正吃透状态管理而非只会调 API 的开发者。
  actions:
    - theme: brand
      text: 开始阅读
      link: ./01-why-state-management
    - theme: alt
      text: 课程介绍
      link: ./about
features:
