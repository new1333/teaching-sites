...
检查读者模型的前置边界、术语首现、承重概念、反事实成因、误区证伪、承诺面和 acceptance prose 条目。判断标准是目标读者能否用新情境复述或推出结论。前置边界失真——正文在教读者早已掌握的内容，或假设了读者不具备且前文未建立的能力——按读者模型失真产出 finding 交修订路由，不在本章就地增删内容硬修。
